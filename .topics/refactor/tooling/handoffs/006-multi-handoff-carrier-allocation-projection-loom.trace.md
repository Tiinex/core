...
- Current
  ...
  - Created At: 2026-09-20 16:28:13
  - Authors: Anchor
...
- prior-qualified-core-return
  - Material: exact Loom → Anchor return that established the current accepted Core frontier and received-package carrier parent.
  - Material Reference: [Qualified Human Session And Participant Projection Return](../../../grounding/handoffs/077-loom-to-anchor-qualified-human-session-and-participant-projectio.trace.md)
  - Purpose: preserve exact received-parent continuity and baseline Core frontier while the new Task is already carried as this Handoff's semantic Parent.
...
- [sha256-base64url-c14n-v2](https://github.com/Tiinex/docs/blob/3988951208eb9a8926e84ab42625d4b42fa00c2d/.topics/.validators/sha256-base64url-c14n-v2.validator.md)
  - Towards: self
  - Value: sT39RKgMOWbEpSY3KVo6NIG1GWiPR5nNI-QaECr41DM