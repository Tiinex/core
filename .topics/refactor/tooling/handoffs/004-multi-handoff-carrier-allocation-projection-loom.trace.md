...
- Current
  ...
  - Created At: 2026-09-20 16:26:08
  - Authors: Anchor
...
- core-workspace
  - Material: complete current Core Workspace including carrier lineage, route projection, manufacture, common-path handoff and accepted participant/session projection.
  - Material Reference: [Core Workspace](core::.topics/.workspaces/tiinex-core.workspace.md)
  - Purpose: sole writable implementation source for this bounded shared Tooling lane.
  - Availability: available

- controlling-core-task
  - Material: exact Task defining the live failure, required projection behavior and no-authority-widening boundary.
  - Material Reference: [Multi-Handoff Carrier Allocation And Route Continuation Projection](../001-2-multi-handoff-carrier-allocation-and-route-continuation-projecti.trace.md)
  - Purpose: controlling acceptance contract.
  - Availability: available
...
- vscode-source
  - Kind: excluded-scope
  - Description: Extension VS Code source is read-only context conceptually and is not mutated in this Loom lane.
...
- [sha256-base64url-c14n-v2](https://github.com/Tiinex/docs/blob/3988951208eb9a8926e84ab42625d4b42fa00c2d/.topics/.validators/sha256-base64url-c14n-v2.validator.md)
  - Towards: self
  - Value: yQ65Ku6_K4NoPgLSjWRJ-Qicv3DOcfGfhTykIx-j3V8