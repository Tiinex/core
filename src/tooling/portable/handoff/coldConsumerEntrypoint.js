...
export function orientColdConsumerFromHandoffPackage(input = {}) {
  ...
  return deepFreeze({
    ...
    operationBoundary: orientationOperationBoundary(null),
...
function orientationOperationBoundary(bootstrapInspection = null) {
  return Object.freeze({
    operationClass: 'local-package-orientation',
    inputScope: 'caller-provided-package-bytes',
    readOnly: true,
    packageContentExecution: false,
    sourceMutation: false,
    remoteMutation: false,
    bootstrapInspection: String(bootstrapInspection?.status || 'unavailable'),
