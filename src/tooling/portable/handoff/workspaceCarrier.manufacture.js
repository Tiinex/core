...
export function manufactureRecipientRelativeWorkspacePackage(input = {}) {
  ...
  const bundle = deepFreeze({ status: 'ready', files: sortedFiles, handoffClosure: null, transportFormat: RECIPIENT_V2_PACKAGE_V1_FORMAT_ID, boundary: 'Pointerless recipient-facing Workspace carrier. Exact qualified direct or generic complete/bounded Workspace source bytes retain authority; carrier placement creates no Handoff semantics.' });
